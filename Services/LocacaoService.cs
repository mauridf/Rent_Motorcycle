...
namespace Rent_Motorcycle.Services
{
    public class LocacaoService
    {
        ...
        public decimal CalcularValorTotalLocacao(DateTime dataInicio, int tipoPlanoId, DateTime dataTermino)
        {
            ...
            if (tipoPlano == null)
            {
                // Se o tipo de plano não for encontrado, retorna 0
                return 0;
            }
        ...
        public async Task<(string, decimal)> EfetuarLocacao(Locacao locacao)
        {
            try
            {
                ...
                if (entregador == null)
                    return ("Somente Entregadores com Habilitação Tipo A podem efetuar Locação.", 0);
                ...
                if (tipoPlano == null)
                    return ("Tipo de Plano inválido.", 0);
            ...
            catch (Exception ex)
            {
                ...
                throw new Exception("Erro ao efetuar uma Locação: " + ex.Message);
            }
        }
    }
}
